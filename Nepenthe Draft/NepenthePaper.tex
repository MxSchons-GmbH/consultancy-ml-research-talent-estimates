...
companies also completed a 3-day ML engineering \& research work trial.
...
\centering
\vspace*{\fill}
\includegraphics[width=\linewidth,keepaspectratio]{images/image4.png}
...
\caption{A) Map of 403 identified ML Consultancies B) Breakdown by Country and category. Organizations are classified into mutually exclusive confidence categories based on their ML engineer estimate distributions (q10, q50, q90 representing the 10th, 50th, and 90th percentiles).}
\label{fig:map}
\end{figure}
...
\subsubsection{ML Engineer (at least 1)}\label{h.dp0ghuwpnjh}
